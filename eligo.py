...
#         """Build milestone dataframe with intelligent cumulative calculation"""
#         data = []
#         total_acts = len(activities)
#         weightage = round(100 / total_acts, 2) if total_acts else 0
...
#                     # FIXED: Only accumulate if tracker exists for this month
...
#                         pct = round(pct, 2)
#                     else:
#                         # No tracker for this month - show only KRA target
#                         pct = 0.0 if cum_target == 0 else (cum_done / cum_target) * 100 if cum_target > 0 else 0.0
#                         pct = min(pct, 100.0)
#                         pct = round(pct, 2)
            ...
            for month in self.quarter_months:
                if is_external:
                    ...
                    if month in months_with_trackers[name]:
                        ...
                        # No tracker for this month - leave blank
